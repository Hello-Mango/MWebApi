...
namespace QuickFire.Infrastructure
{
    public class ApplicationDbContext : AbstractShardingDbContext, IShardingTableDbContext
    {
        ...
        public ApplicationDbContext(ISessionContext sessionContext, DbContextOptions<ApplicationDbContext> options, IConfiguration configuration, IOptions<AppSettings> databaseOption) : base(options)
        {
