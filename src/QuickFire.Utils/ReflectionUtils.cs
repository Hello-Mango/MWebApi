...
public static class ReflectionUtils {
    ...
    public static string GetDescription<T>() {
        return GetDescription(GetType(typeof(T)));
    }
    ...
    public static string GetDescription<T>( string memberName ) {
        return GetDescription(GetType(typeof(T)), memberName );
    }
    ...
    public static string GetDisplayName<T>() {
        return GetDisplayName(GetType(typeof(T)));
    }
    ...
    public static string GetDisplayNameOrDescription<T>() {
        return GetDisplayNameOrDescription(GetType(typeof(T)));
    }
